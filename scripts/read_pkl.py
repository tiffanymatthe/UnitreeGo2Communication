...
if __name__ == "__main__":
    ...
    for joint_idx in range(len(motors_to_plot)):
        ...
        # Plot joint command
        axs.flatten()[joint_idx].plot(commands_to_plot[motor][0], joint_cmd, label=f'Command', color='b')
        
        # Plot joint state
        axs.flatten()[joint_idx].plot(states_to_plot[motor][0], joint_state, label=f'State', color='r', linestyle='--')
